...
# Andá a 'Archivo' -> 'Nuevo Archivo' -> 'Script de R' (Panel superior izquierdo).
...
# ¡Guardá tu script! Anda a 'Archivo' -> 'Guardar Como...' y nómbralo 'Mi_primer_script.R'
# (Elegí una carpeta donde guardar tus scripts, por ejemplo, una carpeta llamada 'Scripts_R_Curso')
