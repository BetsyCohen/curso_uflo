...
¿Por qué paso entraron los turistas que tuvieron un gasto promedio mayor en 2024?
Hace un gráfico de barras que muestre el ranking por paso. 
Para ordenar la variable por ranking vas a tener que convertir la variable paso en factor ordenado usando la función `fct_reorder()` que es parte de la librería `forcats` que como ya te estás imaginando.... pertenece a tidyverse.
Lo hacemos así:
