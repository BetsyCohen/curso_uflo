...
Si alguna vez usaste SQL seguramente vas a decir que son los mismos verbos. 
Ah pero dplyr es ese sombrero nuevo.

!()["https://asterhu.com/post/2023-05-11-coalesce-join-in-R/dplyr.png"]
...
## Iniciemos por llamar a tidyverse 
...
```
la función `select()` me permite hacer esto con muchas columnas. 
Veamos este ejemplo en el que charlamos usando verbos y el pipe (y después)
...
## Crear columnas nuevas con `mutate()`
...
Tidyverse está diseñado para **cubrir de manera integral las diferentes etapas del flujo de trabajo de análisis de datos**:
