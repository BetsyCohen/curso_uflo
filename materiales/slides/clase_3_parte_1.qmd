...
-   ¿Es lo más recomendable si vamos a trabajar desde distintas compus o con otras personas que van a compartir el archivo con nosotros?

-   adivinaste: no.

Es por eso que en situaciones como estas nos ayudamos con un paquete llamado...

##  {background-image="https://raw.githubusercontent.com/allisonhorst/stats-illustrations/master/rstats-artwork/here.png" background-size="1100px"}
...
```{r}
library(dplyr) # llamamos a la librería dplyr que es donde vive la función glimpse
...
Usando la encuesta que descargamos elegi algunas de las columnas e interpretá los datos que te brinda summary. 
Vamos a compartir nuestras conclusiones en clase
:::
