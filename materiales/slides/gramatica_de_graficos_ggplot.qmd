...
`fill` hace referencia al relleno de la geometría (lo vas a usar por ej. con columnas, cajas...) `color` hace referencia al color de la línea que rodea a la geometría
